(function () {
    ...
    class BindingModule {
        ...
        _addRemovePropertyBinding(hostPropertyName, targetPropertyName, targetElement, removeBinding) {
            ...
            const id = targetElement.getAttribute('jqx-id');
        ...
        updateBoundNodes(propertyName) {
            ...
            if (that.ownerElement.detachedChildren.length > 0) {
                for (let i = 0; i < that.ownerElement.detachedChildren.length; i++) {
                    ...
                    const jqxId = node.getAttribute('jqx-id');
                    ...
                    const getBindings = function (bindings) {
                        ...
                        for (let index in bindings.children) {
                            ...
                            const attribute = node.getAttribute ? node.getAttribute('jqx-id') : '';
            ...
            if (!detached) {
                for (let child = node.firstChild; child; child = child.nextSibling) {
                    ...
                    if (child.getAttribute) {
                        const childId = child.getAttribute('jqx-id');
    ...
    class BaseElement extends HTMLElement {
        ...
        ready() {
            ...
            if (that.shadowRoot && JQX(that._selector)) {
                if (JQX(that._selector).styleUrls) {
                    const styleUrls = JQX(that._selector).styleUrls;
        ...
        initProperties() {
            ...
            if (that._initProperties) {
                ...
                for (let i = 0; i < propertyNames.length; i++) {
                    ...
                    if (propertyValue.constructor === JQX.DataAdapter || typeof propertyValue !== 'object' || Utilities.Types.isArray(propertyValue)) {
                    ...
                    if (typeof propertyValue === 'object') {
                        const setHierarchicalProperty = function (propertyValue, path) {
                            ...
                            for (let i = 0; i < subPropertyNames.length; i++) {
                                ...
                                if (typeof subPropertyValue === 'object' && !Utilities.Types.isArray(subPropertyValue) && subPropertyValue.constructor !== Date) {
        ...
        setup() {
            ...
            let templateNodes = [].slice.call(that.querySelectorAll('[jqx-id]')).concat(children);
        ...
        get hasStyleObserver() {
            ...
            if (that._hasStyleObserve !== undefined) {
        ...
        addModule(module, subclasses) {
            ...
            if (subclasses) {
                for (let tagName in JQX.Elements.tagNames) {
                    const element = JQX.Elements.tagNames[tagName];
        ...
        defineElementMethods(methods, proto) {
            ...
            const excludeMethods = ['constructor', 'ready', 'created', 'attached', 'detached', 'appendChild', 'insertBefore', 'removeChild', 'connect', 'disconnectedCallback', 'connectedCallback', 'attributeChangedCallback', 'propertyChangedHandler'];
    ...
    const elementDependencies = {
        ...
        //],
        'jqx-calendar': [
            'jqx-repeat-button', 'jqx-drop-down-list', 'jqx-tooltip'
        ],
        'jqx-card': [
        ...
        'jqx-date-time-picker': [
           'jqx-calendar', 'jqx-time-picker'
        ],
        'jqx-docking-layout': [
            'jqx-splitter', 'jqx-window', 'jqx-tabs'
        ],
        'jqx-drop-down-button': [
            'jqx-button'
        ],
        ...
        'jqx-filter-panel': [
            'jqx-list-box', 'jqx-numeric-text-box', 'jqx-menu', 'jqx-tree', 'jqx-drop-down-list', 'jqx-date-time-picker', 'jqx-calendar', 'jqx-tooltip'
        ],
        'jqx-gauge': [
            'jqx-button', 'jqx-tank'
        ],
        'jqx-grid': [
            'jqx-grid-cell', 'jqx-grid-column', 'jqx-grid-row', 'jqx-input', 'jqx-menu', 'jqx-filter-panel', 'jqx-pager', 'jqx-date-time-picker'
        ],
        'jqx-grid-cell': [
            'jqx-grid'
        ],
        ...
        'jqx-list-box': [
            'jqx-scroll-viewer', 'jqx-list-item', 'jqx-list-items-group'
        ],
        'jqx-list-item': [
            'jqx-list-box'
        ],
        ...
        'jqx-list-menu': [
             'jqx-menu', 'jqx-list-menu-item', 'jqx-list-menu-items-group'
        ],
        'jqx-list-menu-item': [
          'jqx-list-menu'
        ],
        'jqx-list-menu-items-group': [
            'jqx-list-menu'
        ],
        'jqx-masked-text-box': [
            'jqx-text-box'
        ...
        'jqx-menu': [
            'jqx-scroll-viewer', 'jqx-menu-item'
        ],
        'jqx-multiline-text-box': [
            'jqx-text-box'
        ],
        'jqx-multiline-split-button': [
           'jqx-drop-down-button'
        ],
        ...
        'jqx-radio-button': [
            'jqx-button', 'jqx-toggle-button'
        ],
        'jqx-scroll-bar': [

        ],
        'jqx-slider': [
            'jqx-button', 'jqx-repeat-button', 'jqx-tank'
        ],
        'jqx-sortable': [
            'jqx-button'
        ],
        ...
        //],
        'jqx-sort-panel': [
           'jqx-input', 'jqx-sortable'
        ],
        'jqx-switch-button': [
           'jqx-toggle-button'
        ],
        'jqx-scroll-viewer': [
            'jqx-button', 'jqx-scroll-bar'
        ],
        'jqx-table':
        [
        ],
        'jqx-tabs': [
           'jqx-repeat-button', 'jqx-tab-item', 'jqx-tab-items-group'
        ],
        'jqx-tab-item': [
            'jqx-tabs'
        ],
        ...
        'jqx-tree': [
             'jqx-menu', 'jqx-tree-item', 'jqx-tree-items-group'
        ],
        'jqx-tree-item': [
          'jqx-tree'
        ],
    ...
    class ElementRegistry {
        ...
        static register(tagName, element) {
            ...
            if (window[namespace].Define && window[namespace].Define.indexOf(tagName) === -1
                && (tagName !== 'jqx-base-element'
                && tagName !== 'jqx-content-element'
                && tagName !== 'jqx-scroll-viewer')) {
                ...
                const getAllDependencies = function (tagName, dependencies) {
                    const tagNames = elementDependencies[tagName];
                    ...
                    if (tagNames) {
                        for (let i = 0; i < tagNames.length; i++) {
                            const currentTagName = tagNames[i];
                ...
                const tags = window[namespace].Define;
                const newTags = tags.slice(0);

                for (let i = 0; i < tags.length; i++) {
                    let dependencies = getAllDependencies(tags[i]);
    ...
    class ObservableArray {
        ...
        _createPropertyChangeData(propertyName, value, oldValue) {
            return { eventName: 'change', object: this, propertyName, value, oldValue };
        }
        ...
        splice(start, deleteCount, addCount) {
            ...
            const result = that._array.splice.apply(that._array, arguments);
    ...
    window.addEventListener('load', function () {
        ...
        for (let tagName in tagNames) {
            ...
            for (let j = 0; j < elements.length; j++) {
                ...
                element.classList.add('jqx-element-ready');
            }
        }
    });
    ...
    class Component {
        constructor(selector, properties) {
            const element = new window[namespace](selector, properties);
    ...
    class App {
        constructor(object) {
            ...
            that._id = object.id || window[namespace].Utilities.Core.createGUID();
        ...
        _updateDataFromBooleanElement(element, bind) {
            ...
            const bindItem = that.data[boundPropertyName];
        ...
        _updateDataFromNativeElement(element, bind) {
            ...
            if (element.tagName === 'SELECT') {
                element.addEventListener('change', function () {
                    ...
                    let dataItem = that.data[boundPropertyName];
        ...
        _addModelBindings(ownerElement) {
            ...
            const elements = ownerElement ? ownerElement.querySelectorAll('[jqx-model]') : that._appRoot.querySelectorAll('[jqx-model]');

            for (let i = 0; i < elements.length; i++) {
                const element = elements[i];
                let bind = { value: element.getAttribute('jqx-model') };

                if (element.type === 'list') {
                    bind = { selectedValues: element.getAttribute('jqx-model') };
                }

                if (element.type === 'checkbox' || element.type === 'radio') {
                    bind = { checked: element.getAttribute('jqx-model') };
                }

                if (!element.id) {
                    element.id = 'id' + JQX.Utilities.Core.createGUID().replace(/-/ig, '');
                }
        ...
        _renderForBindings(invokeRender) {
            ...
            const elements = that._appRoot.querySelectorAll('[jqx-for]');

            for (let i = 0; i < elements.length; i++) {
                const element = elements[i];
                const dataName = element.getAttribute('jqx-for');
                const array = that.data[dataName];

                if (!element.id) {
                    element.id = 'id' + JQX.Utilities.Core.createGUID().replace(/-/ig, '');
                }

                element.setAttribute('jqx-for-rendered', '');

                const selfRepeat = element.getAttribute('jqx-for-self') !== null;
                const toRemove = !selfRepeat ? element.querySelectorAll('.jqx-for-item-' + element.id) : element.parentNode.querySelectorAll('.jqx-for-item-' + element.id);
                ...
                for (let j = 0; j < array.length; j++) {
                    ...
                    clonedNode.classList.add('jqx-for-item-' + element.id);
                ...
                let children = that._appRoot.querySelectorAll('.jqx-for-item-' + element.id);
        ...
        _observeData() {
            ...
            for (let dataItem in that.data) {
                ...
                const dataItemValue = that.data[dataItem];
        ...
        render() {
            ...
            for (let selector in that.template) {
                ...
                for (let propertyName in properties) {
                    const property = element._properties[propertyName];
                        ...
                        if (property) {
                            ...
                            if (element.type === 'textarea') {
                                element.$[type]('input.keyup', function (event) {
                                    const customEvent = new CustomEvent('keyup', { detail: { originalEvent: event, value: element.$.input.value } });
    ...
    * Content element.
    */
    window[namespace]('jqx-content-element', class ContentElement extends window[namespace].BaseElement {
        static get properties() {
            return {
                'content': {
                    type: 'any',
    ...
    window[namespace]('jqx-scroll-viewer', class ScrollViewer extends window[namespace].ContentElement {
        static get properties() {
            return {
        ...
        _mouseWheelHandler(event) {
            ...
            if (that.computedVerticalScrollBarVisibility) {
                ...
                if (that.scrollWidth > 0) {
                    that.scrollTo(undefined, that.scrollLeft + (event.deltaY < 0 ? -that.offsetWidth : that.offsetWidth));
                }
            }
        ...
        refresh() {
            ...
            function getScrollWidth() {
                scrollWidth = that.$.scrollViewerContentContainer.offsetWidth - that.$.scrollViewerContainer.offsetWidth;
    ...
    window[namespace].Utilities.Assign('PositionDetection', class PositionDetection {
        ...
        checkBrowserBoundsHorizontally() {
            ...
            if (currentOffsetLeft + dropDown.offsetWidth > windowWidth) {
                const newOffset = currentOffsetLeft - Math.abs(windowWidth - currentOffsetLeft - dropDown.offsetWidth),
