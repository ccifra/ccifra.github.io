...
JQX('jqx-calendar', class Calendar extends JQX.BaseElement {
    ...
    */
    _headerChangeHandler(event) {
        ...
        if (that.$.monthElement && event.target.ownerElement === that.$.monthElement) {
    ...
    */
    _refreshMonthNames() {
        ...
        if (that.calendarMode === 'classic' && that.$.monthElement) {
            ...
            //NOTE: when shadowDOM is Enabled, sometimes the context is not document and dataSource isn't being handled
            const context = that.$.monthElement.context;

            that.$.monthElement.context = document;
            that.$.monthElement.dataSource = that._monthsNames;
            that.$.monthElement.context = context;
