...
window.jqxBaseFramework = window.minQuery || window.jQuery;
...
(function ($) {
    ...
    $.extend($.jqx.utilities,
    {
        ...
        html: function (element, value) {
            var rinlinejQuery = / JQXLite\d+="(?:null|\d+)"/g;
            if (!$(element).on) {
    ...
    $.extend($.jqx.mobile,
    {
        ...
        touchScroll: function (element, scrollHeight, callback, key, horizontalScroll, verticalScroll)
        {
            ...
            var view, indicator, relative,
               ...
               amplitude, target, xtarget, xreference, timeConstant, xdelta, xv, xjqxAnimations, touchHorizontalEnd;
            max = scrollHeight;
            min = 0;
            offset = 0;
            var xoffset = 0;
