    ...
    $.jqx.dataAdapter.prototype = {
            ...
            switch (datatype) {
                ...
                default:
                    ...
                    if (options.autoSort && options.autoSortField) {
                        ...
                        // Usages of autoSort/autoSortField indicate that we don't expect a function that returns a field name
                        // Declared field below to suppress linting errors.
                        var field = undefined;
        ...
        _requestData: function (postdata, source, options) {
            ...
            var success = function (requestedData) {
                ...
                if (options.beforeLoadComplete) {
                    // beforeLoadComplete is set in jqxgrid.filter.js and ignores the second argument.
                    // Commented out the 'data' parameter to suppress linting errors
                    var newRecords = options.beforeLoadComplete(me.records /*,  data */);
                    if (newRecords != undefined) {
                        me.records = newRecords;
                        me.cachedrecords = newRecords;
